...
/***/ (function(module, exports, __webpack_require__) {
  ...
  var buildFullPath = __webpack_require__(356);
  ...
  var product = exports.product = document.querySelector("#products");
  var filter = exports.filter = document.querySelector("#filters-year");
  var launch = exports.launch = document.querySelector("#filter-launch");
  var landing = exports.landing = document.querySelector("#filter-landing");
  var yearFilter = exports.yearFilter = document.querySelectorAll('.year');
  var launchFilter = exports.launchFilter = document.querySelectorAll('.launch');
  var landingFilter = exports.landingFilter = document.querySelectorAll('.landing');
  ...
  var _https = __webpack_require__(344);
  
  var http = _interopRequireWildcard(_https);
  ...
  function getEnteredFilterValue(e) {
      ...
      var filteValue = e.target.textContent;
  
      //Removing the selcted class
      selector.yearFilter.forEach(function (ele) {
  ...
  function getLaunchFilterValue(e) {
      var launchValue = e.target.textContent;
  
      console.log(launchValue);
  
      //Removing the selcted class
      selector.launchFilter.forEach(function (ele) {
          ele.classList.remove('selected');
      });
  ...
  function getLandingFilterValue(e) {
      var launchFilterValue = void 0;
      var landingValue = e.target.textContent;
      console.log(landingValue);
  
      //Removing the selcted class
      selector.landingFilter.forEach(function (ele) {
          ele.classList.remove('selected');
      });
  ...
  exports.getLandingSuccessFilter = exports.getLaunchSucessFilter = exports.getEnteredFilterValue = exports.getAllProductList = undefined;
  
  var _axios = __webpack_require__(345);
  
  var _axios2 = _interopRequireDefault(_axios);
  
  var _api = __webpack_require__(363);
  
  var api = _interopRequireWildcard(_api);
  
  var _productView = __webpack_require__(364);
  
  var product = _interopRequireWildcard(_productView);
  
  function _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key]; } } newObj.default = obj; return newObj; } }
  
  function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
  
  var getAllProductList = exports.getAllProductList = function getAllProductList() {
  
      _axios2.default.get(api.allProducts).then(function (response) {
  ...
  var getEnteredFilterValue = exports.getEnteredFilterValue = function getEnteredFilterValue(filterValue) {
  
      _axios2.default.get(api.yearFilter + filterValue).then(function (response) {
          product.showProduct(response.data);
      }).catch(function (error) {
          console.log(error);
      });
  ...
  var getLaunchSucessFilter = exports.getLaunchSucessFilter = function getLaunchSucessFilter(launchFilterValue) {
      _axios2.default.get(api.launch + launchFilterValue).then(function (response) {
          product.showProduct(response.data);
      }).catch(function (error) {
          console.log(error);
      });
  ...
  var getLandingSuccessFilter = exports.getLandingSuccessFilter = function getLandingSuccessFilter(launch, landing) {
  
      _axios2.default.get(api.launch + launch + '&land_success=' + landing).then(function (response) {
          product.showProduct(response.data);
      }).catch(function (error) {
          console.log(error);
      });
  ...
  var allProducts = exports.allProducts = 'https://api.spacexdata.com/v3/launches?limit=100';
  var yearFilter = exports.yearFilter = 'https://api.spacexdata.com/v3/launches?limit=100&amp;launch_success=true&amp;land_success=true&launch_year=';
  
  var launch = exports.launch = 'https://api.spacexdata.com/v3/launches?limit=100&amp;launch_success=';
  ...
  var showProduct = exports.showProduct = function showProduct(products) {
      ...
      function productmission(product) {
          ...
          if (product.mission_id.length > 0) {
              product.mission_id.forEach(function (id) {
                  missionid += '\n                    <li>' + id + '</li>\n                ';
              });
          } else {
              missionid = '';
